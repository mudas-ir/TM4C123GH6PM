...
int main(void)
{
    ...
    while(1)
    {
        ...
        while((ADC0_RIS_R & 1) == 0);     // Wait for conversion to complete
...
unsigned char key_scan(unsigned int volatile rec_val)
{
    ...
    if(rec_val == 0xB7 || rec_val == 0xB6) return '0';
    else if(rec_val == 0xB3 || rec_val == 0xB2) return '1';
    else if(rec_val == 0xAE || rec_val == 0xAD) return '2';
    else if(rec_val == 0xAA || rec_val == 0xA9) return '3';
    else if(rec_val == 0xA6 || rec_val == 0xA7) return '4';
    else if(rec_val == 0xA0 || rec_val == 0x9F) return '5';
    else if(rec_val == 0x98 || rec_val == 0x97) return '6';
    else if(rec_val == 0x92 || rec_val == 0x91) return '7';
    else if(rec_val == 0x8C || rec_val == 0x8B) return '8';
    else if(rec_val == 0x81 || rec_val == 0x80) return '9';
    else if(rec_val == 0x73 || rec_val == 0x72) return 'A';
    else if(rec_val == 0x66 || rec_val == 0x65) return 'B';
    else if(rec_val == 0x5A) return 'C';
    else if(rec_val == 0x41) return 'D';
    else if(rec_val == 0x20) return 'E';
    else if(rec_val == 0x00) return 'F';
